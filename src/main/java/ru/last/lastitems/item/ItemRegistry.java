...
public class ItemRegistry {
    ...
    public ItemRegistry(@NotNull LastItemsFree plugin) { this.idKey = new NamespacedKey(plugin, "lastitems_free"); }
    ...
    public Set<String> getFolders() { return folderRegistry.keySet(); }

...
public class KillEntityTrigger implements Listener {
    ...
    public KillEntityTrigger(ItemRegistry itemRegistry) { this.itemRegistry = itemRegistry; }
    ...
    public void onEntityDeath(EntityDeathEvent event) {
        ...
        if (customItem != null) customItem.executeTrigger(ActionTrigger.ON_KILL_ENTITY, new TriggerContext(player, item, event.getEntity(), event));
    }
}